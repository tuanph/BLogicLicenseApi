...
namespace BLogicLicense.Web.App_Start
{
    public class ApplicationUserStore : UserStore<AppUser>
    {
        public ApplicationUserStore(BLogicLicenseDbContext context)
            : base(context)
        {
        }
    }
    public class ApplicationRoleManager : RoleManager<AppRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<AppRole>(context.Get<BLogicLicenseDbContext>()));
        }
    }
    ...
    public class ApplicationUserManager : UserManager<AppUser>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<AppUser>(context.Get<BLogicLicenseDbContext>()));
