namespace BLogicLicense.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BLogicLicense.Data.BLogicLicenseDbContext>
    {
        ...
        private void CreateProductCategorySample(BLogicLicense.Data.BLogicLicenseDbContext context)
        {
        ...
        private void CreateSize(BLogicLicense.Data.BLogicLicenseDbContext context)
        {
        ...
        private void CreateColor(BLogicLicense.Data.BLogicLicenseDbContext context)
        {
        ...
        private void CreateFooter(BLogicLicenseDbContext context)
        {
        ...
        private void CreateSlide(BLogicLicenseDbContext context)
        {
        ...
        private void CreatePage(BLogicLicenseDbContext context)
        {
        ...
        private void CreateContactDetail(BLogicLicenseDbContext context)
        {
            if (context.ContactDetails.Count() == 0)
            {
                try
                {
                    var contactDetail = new BLogicLicense.Model.Models.ContactDetail()
                    {
